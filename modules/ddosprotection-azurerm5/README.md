# Vendored avm-res-network-ddosprotectionplan module for azurerm 5.x

This directory vendors `Azure/avm-res-network-ddosprotectionplan/azurerm` from upstream repository `Azure/terraform-azurerm-avm-res-network-ddosprotectionplan`, version `v0.3.0`.
...
1. `terraform.tf`
   - `terraform.required_version`: upstream `>= 1.6.0` → vendored `>= 1.10`.
2. `terraform.tf`
